...
//     {
//       img: "/assets/gif2.gif",
//       title: "Un accompagnement sur-mesure pour répondre à vos besoins spécifiques",
...
//         <div className="fixed right-5 top-1/3 space-y-4">
//       {/* WhatsApp */}
//       <motion.div
//         initial={{ opacity: 0 }}
//         animate={{ opacity: 1 }}
...
//       >
//         <a
//           href="https://wa.me/11234567890" // Remplacez ce lien par votre propre numéro WhatsApp
//           target="_blank"
...
//   {/* <motion.h1
//     className="m-auto text-center font-waterfall text-3xl md:text-6xl text-gradient font-bold my-2 md:my-4" // Marges encore plus petites
//     initial={{ opacity: 0, y: 50 }} // Position de départ
//     whileInView={{ opacity: 1, y: 0 }} // Animation quand visible
//     transition={{ duration: 1, ease: "easeOut" }} // Durée et fluidité
//     viewport={{ once: true }} // S'exécute une seule fois
//   >
...
//   initial={{ opacity: 0 }} // La section commence invisible
//   whileInView={{ opacity: 1 }} // Elle devient visible lorsqu'elle entre dans le viewport
//   transition={{ duration: 2, ease: "easeOut" }} // Durée plus lente de l'animation
//   viewport={{ once: false, amount: 0.3 }} // Se rejoue chaque fois que la section devient visible à 30%
// >
...
//       }}
//       initial={{ opacity: 0, x: -100 }} // Carte commence invisible et à gauche
//       whileInView={{ opacity: 1, x: 0 }} // Carte devient visible et se déplace vers sa position d'origine
//       transition={{ duration: 2, ease: "easeOut" }} // Animation lente
//       viewport={{ once: false, amount: 0.3 }} // L'animation se déclenche à 30% de visibilité
//     >
//       <Image
//         src={card.img}
